const events: TimelineEvent[] = [
    {
        ...
        description: 'The getlinked tech hackathon 1.0 is formally announced to the general public and teams begin to ' +
            'get ready to register',
        date: 'November 18, 2023',
    },
    {
        title: 'Teams Registration begins',
        description: 'Interested teams can now show their interest in the getlinked tech hackathon 1.0 2023 by ' +
    ...
    {
        title: 'Demo Day',
        description: 'Teams get the opportunity to pitch their projects to judges. The winner of the hackathon' +
