    ...
    return <header className="flex flex-col min-h-screen">
        <div className="mobile-view lg:hidden">
            ...
            <div className="flex flex-col mx-[4.9rem] leading-normal">
                <h1 className="font-clash-display text-brand-pink text-[2rem] font-semibold">
                ...
                <button className="button-primary self-center my-[4.2rem]">Submit</button>
                <span className="text-brand-pink text-[1.2rem] text-center pb-2">Share on</span>
        ...
        <div className="desktop_view hidden lg:flex flex-col flex-1">
            ...
            <div className="flex-1 flex items-center pl-[18.8rem] text-[1.6rem]">
                <div className="basis-[45.8%]">
                    <h2 className="font-semibold font-clash-display text-brand-pink text-[3.2rem]">Get in touch</h2>
                    ...
                    <div className="text-brand-pink mt-[3.5rem] mb-[1.4rem]">Share on</div>
                ...
                <div className="bg-[#FFFFFF07] px-[9rem] py-[7.5rem]">
                    <h2 className="font-semibold font-clash-display text-brand-pink text-[2rem]">
                    ...
                    <div className="flex flex-col py-[.6rem] space-y-[2.5rem] w-[43.7rem]">
                        ...
                        <textarea className="mobile-input-control !px-[2.4rem] !py-[2.7rem]" placeholder="Message" rows={4}/>
                        <button className="button-primary self-center my-[3.1rem]">Submit</button>
                    </div>
                </div>
            </div>
        </div>
